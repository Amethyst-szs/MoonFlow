...
## Force vertical mouse wheel inputs to scroll horizontally
@export
var force_horizontal_scrolling := false
## Force horizontal mouse wheel inputs to scroll vertically
@export
var force_vertical_scrolling := false
