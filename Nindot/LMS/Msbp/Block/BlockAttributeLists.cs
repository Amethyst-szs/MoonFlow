...
public class BlockAttributeLists(byte[] data, string listingName, int offset, MsbpFile parent) : Block(data, listingName, offset, parent)
{
    ...
    private void InitList(byte[] data, int offset)
    {
        ...
        for (int i = 0; i < nameCount; i++)
        {
            ...
            l.Add(Encoding.UTF8.GetString(data[itemPointer..endPointer]));
        }
